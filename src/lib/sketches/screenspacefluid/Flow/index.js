...
import vert from './shaders/triangle.vert?raw';
import opticalFlowFrag from './shaders/opticalflow.frag?raw';
import captureFrag from './shaders/capture.frag?raw';
import blur from './shaders/blur.frag?raw';
